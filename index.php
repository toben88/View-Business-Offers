...
<div class="container">
  ...
  <?php if (isset($_SESSION['save_message'])): ?>
    <div class="card" style="background:#ecfdf5;border-left:4px solid #10b981;margin-bottom:20px;">
      <p style="color:#10b981;margin:0;">✓ <?php echo htmlspecialchars($_SESSION['save_message']); ?></p>
    </div>
  ...
  <?php if (isset($_SESSION['error_message'])): ?>
    <div class="card" style="background:#fef2f2;border-left:4px solid #ef4444;margin-bottom:20px;">
      <p style="color:#ef4444;margin:0;">✗ <?php echo htmlspecialchars($_SESSION['error_message']); ?></p>
    </div>
  ...
  <div class="graph-container">
    <h2>📊 Cash Flow Timeline - Money Received Over Time</h2>
  ...
  <div class="offers-grid">
    ...
    <div class="offer-card <?php echo $isBest ? 'best' : ''; ?>">
      ...
      <div class="metric">
        <div class="metric-label">💰 Cash at Closing</div>
      ...
      <div class="metric">
        <div class="metric-label">📝 Seller Note Terms</div>
      ...
      <div class="metric">
        <div class="metric-label">💳 Monthly Payment from Buyer</div>
      ...
      <div class="timeline-section">
        <div class="metric">
          <div class="metric-label">📅 Total Money in 5 Years</div>
          <div class="metric-value" style="color:#06b6d4;">$<?php echo number_format($total5yr, 0); ?></div>
        </div>

        <div class="metric">
          <div class="metric-label">📅 Total Money in 10 Years</div>
      ...
      <div class="metric">
        <div class="metric-label">⚠️ Contingencies / Notes</div>
